    ...
    methods: {
        ...
        handleIndexRoutes() {
            ...
            for (let i = 0; i < filterRoutes.length; i++) {
                // console.log(this.$route.name + ':' + filterRoutes[i].name)
                // console.log(this.$route.name)
                if (this.$route.name.slice(0, filterRoutes[i].name.length).indexOf(filterRoutes[i].name) !== -1) {
                    this.filterRoutes = filterRoutes[i].children
                }
            }
        }
    },
